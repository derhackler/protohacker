defmodule Protohacker.Application do
  ...
  alias Protohacker.BudgetChatAcceptor
  ...
  def start(_type, _args) do
    children = [
      {DynamicSupervisor, name: TcpConnections, restart: :temporary},
      ...
      %{id: :challange4_budget_chat,      start: {BudgetChatAcceptor, :start_link, [5004,  [packet: :line, packet_size: 100_000, buffer: 100_000]]}},
    ]
